...
export class Backend implements backendInterface {
    ...
    async addPortfolioItem(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addPortfolioItem(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getVisitCounter(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getVisitCounter();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async incrementVisitCounter(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.incrementVisitCounter();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
